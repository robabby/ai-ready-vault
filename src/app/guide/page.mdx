...
<div className="mt-4 mb-6 p-4 border border-phosphor-dim/30 rounded-lg bg-phosphor-ghost">
...
<nav className="mb-8 p-4 border border-border rounded-lg bg-elevated">
