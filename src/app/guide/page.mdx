...
export const metadata = {
  title: "Guide | AI-Ready Vault",
  description: "Learn how to structure your Obsidian vault for effective AI collaboration.",
};
...
<nav className="mt-4 mb-8 p-4 border border-border rounded-lg bg-elevated">
  <p className="text-phosphor-dim text-sm uppercase tracking-wide mb-3"># Table of Contents</p>
...
Ready to get started? [Download a starter vault](/downloads) and begin building your AI-ready system.
